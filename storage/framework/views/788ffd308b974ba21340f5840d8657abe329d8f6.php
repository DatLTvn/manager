...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- font CSS -->
    <link
        href='<?php echo e(asset('public/backend//fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic')); ?>'
...
<body>
    <div class="log-w3">
        ...
        <form action="" method="post">
            ...
            <input type="text" class="ggg" name="admin_password" placeholder="Điền mật khẩu" required="">
           
            <h6><a href="<?php echo e(URL::to('/sign-in-users')); ?>">Đăng kí tài khoản</a></h6>
...
<?php /**PATH C:\xampp\htdocs\relaravel\resources\views/users/login_users.blade.php ENDPATH**/ ?>