                                ...
                                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="cart-pic first-row"><img
                                                src="<?php echo e('public/upload/' . $cart->product_file); ?>" alt=""
                                                width="100" height="100" /></td>
                                        <td class="cart-title first-row">
                                            <h5><?php echo e($cart->product_name); ?></h5>
                                        </td>
                                        <td class="p-price first-row">
                                            <?php echo e(number_format($cart->product_price, 0, ',', '.') . ' Vnd'); ?></td>
                                        ...
                                        <td class="total-price first-row">
                                            <?php echo e(number_format($cart->product_price * $cart->quantity, 0, ',', '.') . ' Vnd'); ?>

                                        </td>
                                        <td class="close-td first-row"><a href="<?php echo e(route('deleteCart',$cart->id)); ?>"><i class="ti-close"></i></a>
                                        </td>
                            ...
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Subtotal
                                        <span><?php echo e(number_format($totalCart), 0, ',', '.'); ?></span>
                                    </li>
                                    <li class="cart-total">Total
                                        <span><?php echo e(number_format($totalCart), 0, ',', '.'); ?></span>
                                    </li>
                                </ul>
                                <a href="<?php echo e(route('checkout')); ?>" class="proceed-btn">PROCEED TO CHECK OUT</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\relaravel\resources\views/categories/list_info.blade.php ENDPATH**/ ?>